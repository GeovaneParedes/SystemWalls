export class WMSCoreService {
    ...
    // --- MÉTODOS FEFO & WMS ---
    obterLotesOrdenadosFEFO() {
        return Array.from(this.lotes.values()).sort((a, b) => new Date(a.dataValidade).getTime() - new Date(b.dataValidade).getTime());
    }
    obterEnderecos() {
    ...
    calcularConversaoEntrada(qtdCaixas, fatorConversao) {
